...
const ReuseQuestion = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const url = `https://online-exam-server.vercel.app/questionSet/${questionId}`;
    fetch(url, {
      method: "PUT",
      headers: {
    ...
    <div>
      ...
      <div className="container px-5 py-8 mx-auto">
        <div className="flex flex-col text-center w-full mb-12 items-center">
          <p className="text-4xl title-font mb-4 font-bold text-purple-900">
            Reuse Questions
          </p>
          <form
          ...
          >
            ...
            <button
              type="submit"
              className="text-xl bg-pink-200 text-purple-900 rounded-md px-5 py-2"
            >
              Change
            </button>
          </form>
