    ...
    return (
        <div className="flex flex-col w-full">
            ...
            <div className="flex items-center">
                ...
                <button onClick={handleRemoveOption} className="hover:bg-gray-100 p-2 rounded-full mx-4 md:mx-0">{<ImCross className="text-lg" />}</button>
            </div>
            <div className="flex mt-2">
                <button onClick={HandleAddOption} title="Add new option" className="hover:bg-gray-100 p-2 rounded-full mr-4 md:mr-3">{<GrAddCircle className="text-2xl" />}</button>
