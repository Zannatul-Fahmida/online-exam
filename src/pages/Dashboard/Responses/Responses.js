...
const Responses = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://online-exam-server.vercel.app/questionSet/${id}`)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`https://online-exam-server.vercel.app/responses/${id}`)
      .then((res) => {
          ...
          <div className="p-4 lg:w-1/2 w-full">
            <div className="flex flex-col border-2 items-center justify-center rounded-lg border-gray-200 border-opacity-50 p-8 bg-gradient-to-t from-purple-700 via-purple-600 to-purple-700">
              ...
              <div className="text-center text-white font-medium">
                ...
                <h2 className="title-font text-2xl mb-5">
                  Your score {userScore.score} out of {userScore.totalMarks}
                </h2>
                <p className="my-3">Score of multiple choice and checkbox</p>
                <Link
                  to="/dashboard"
                  className="text-xl bg-pink-200 text-purple-900 rounded-md px-5 py-2 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:transform-none"
                >
                  Back to Dashboard
                </Link>
              </div>
